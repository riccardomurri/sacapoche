...
#
"""
Implementation of Fliege's linear system solver, with some
experimental modifications.

This code uses exact arithmetic (fractions of arbitrary-precision
integers) to avoid numerical stability issues.
